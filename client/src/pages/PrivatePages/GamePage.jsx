        ...
        <div className="game-page-container">
            <div className="left-side">
                ...
                <div className="general-player1">
                    {gameInfo?.player_current?.player_name ===
                        userInfo?.nickname && (
                        <CardComponent
                            card={gameInfo?.player_current?.player_leader}
                        ></CardComponent>
                    )}
                </div>
            </div>
            ...
            <div className="center-side">
                ...
                <div className="row-box-player1">
                    ...
                    <div className="row">
                        ...
                        <div
                            className={
                                gameInfo?.player_current?.player_card_selected
                                    ?.row === 'close'
                        ...
                        >
                            {gameInfo?.player_current?.player_name ===
                                userInfo?.nickname &&
                                gameInfo?.player_current?.player_cards_board?.[0]?.board_row_cards?.map(
                                    (item, index) => (
                                        <CardPlayedComponent
                                            key={index}
                                            card={item}
                    ...
                    <div className="row">
                        ...
                        >
                            {gameInfo?.player_current?.player_name ===
                                userInfo?.nickname &&
                                gameInfo?.player_current?.player_cards_board?.[1]?.board_row_cards?.map(
                                    (item, index) => (
                                        <CardPlayedComponent
                                            key={index}
                                            card={item}
                    ...
                    <div className="row">
                        ...
                        >
                            {gameInfo?.player_current?.player_name ===
                                userInfo?.nickname &&
                                gameInfo?.player_current?.player_cards_board?.[2]?.board_row_cards?.map(
                                    (item, index) => (
                                        <CardPlayedComponent
                                            key={index}
                                            card={item}
                ...
                <div className="row-box-cards">
                    ...
                    >
                        {gameInfo?.player_current?.player_name ===
                            userInfo?.nickname &&
                            gameInfo?.player_current?.player_cards_current?.map(
                                (item, index) => (
                                    <CardComponent
                                        key={index}
                                        card={item}
